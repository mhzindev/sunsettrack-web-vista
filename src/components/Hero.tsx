  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-darker-blue via-dark-blue to-darker-blue relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="absolute w-[1000px] h-[1000px] opacity-40">
          <img 
            src="/lovable-uploads/1a2e36e4-8838-485b-a874-3bd761f855c1.png" 
            alt="Earth from space"
            className="w-full h-full object-cover rounded-full"
          />
        </div>
        
        {/* Globe glow effect overlay */}
        <div className="absolute w-[1000px] h-[1000px] rounded-full bg-gradient-to-br from-blue-600/20 via-blue-500/10 to-transparent opacity-60 blur-sm"></div>
        <div className="absolute w-[800px] h-[800px] rounded-full bg-gradient-to-tr from-primary/30 via-blue-400/20 to-transparent"></div>
        
        {/* Grid lines overlay */}
        <div className="absolute w-[800px] h-[800px] rounded-full border border-blue-400/15"></div>
        <div className="absolute w-[800px] h-[800px] rounded-full border border-blue-300/10 transform rotate-45"></div>
        <div className="absolute w-[700px] h-[700px] rounded-full border border-blue-300/15 transform rotate-12"></div>
        <div className="absolute w-[600px] h-[600px] rounded-full border border-blue-300/10 transform -rotate-12"></div>
        
        {/* Horizontal grid lines */}
        <div className="absolute w-[800px] h-px bg-gradient-to-r from-transparent via-blue-300/15 to-transparent top-1/2 transform -translate-y-1/2"></div>
        <div className="absolute w-[750px] h-px bg-gradient-to-r from-transparent via-blue-300/10 to-transparent top-1/2 transform -translate-y-16"></div>
        <div className="absolute w-[750px] h-px bg-gradient-to-r from-transparent via-blue-300/10 to-transparent top-1/2 transform translate-y-16"></div>
        <div className="absolute w-[680px] h-px bg-gradient-to-r from-transparent via-blue-300/8 to-transparent top-1/2 transform -translate-y-32"></div>
        <div className="absolute w-[680px] h-px bg-gradient-to-r from-transparent via-blue-300/8 to-transparent top-1/2 transform translate-y-32"></div>
        
        {/* Vertical grid lines */}
        <div className="absolute h-[800px] w-px bg-gradient-to-b from-transparent via-blue-300/15 to-transparent left-1/2 transform -translate-x-1/2"></div>
        <div className="absolute h-[750px] w-px bg-gradient-to-b from-transparent via-blue-300/10 to-transparent left-1/2 transform -translate-x-16"></div>
        <div className="absolute h-[750px] w-px bg-gradient-to-b from-transparent via-blue-300/10 to-transparent left-1/2 transform translate-x-16"></div>
      </div>
