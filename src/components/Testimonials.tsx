...
const Testimonials = () => {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-dark-blue to-darker-blue font-rethink">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => {
            ...
            return (
              <Card key={index} className="bg-gradient-to-br from-primary/20 to-transparent border border-primary/20 backdrop-blur-sm">
